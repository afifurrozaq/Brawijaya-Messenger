...
import com.yokoding.afifur.brawijayamessenger.adapter.UserContactAdapter;
...
public class ContactFragment extends Fragment {
    ...
    private UserContactAdapter mUsersChatAdapter;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View a = inflater.inflate(R.layout.fragment_contact, container, false);
        mProgressBarForUsers = (ProgressBar) a.findViewById(R.id.progress_bar_users2);
        mUsersRecyclerView = (RecyclerView) a.findViewById(R.id.recycler_view_users2);
        setAuthInstance();
        setUsersDatabase();
        setUserRecyclerView();
        setUsersKeyList();
    ...
    private void setUserRecyclerView() {
        ...
        mUsersChatAdapter = new UserContactAdapter(getActivity(), new ArrayList<User>());
        mUsersChatAdapter.fragmentActivity=getActivity();
    ...
    private void setUserOffline() {
        if(mAuth.getCurrentUser()!=null ) {
            ...
            mUserRefDatabase.child(userId).child("connection").setValue(UserContactAdapter.OFFLINE);
        }
    }
